...
var updateProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, product, updateData, filteredData, updatedProduct, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                productId = req.params.id;
                return [4 /*yield*/, product_1.Product.findByPk(productId)];
            case 1:
                product = _a.sent();
                if (product === null)
                    return [2 /*return*/, res.status(400).json({ message: "상품이 존재하지 않습니다." })];
                updateData = {
